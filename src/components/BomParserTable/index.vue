        ...
        >
            ...
            <el-table-column prop="" label="推荐匹配商品" class-name="column_result" min-width="200">
                ...
                `
                        ...
                        <MoreParameterPopover :parameter="row.matchedIcDatas[0]"></MoreParameterPopover>
                    </div>
                </template>
            </el-table-column>
            ...
            <el-table-column prop="" label="购买数量" class-name="column_result" min-width="100">
                <template #default="{ row }">
                    <el-input v-model="row.quantity" placeholder="" clearable @change="" v-if="hasMatchedMaterial(row)"></el-input>
                </template>
            </el-table-column>
