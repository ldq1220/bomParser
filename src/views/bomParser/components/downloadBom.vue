<template>
  <div class="download_bom_btn">
    <el-button type="primary" plain size="default" @click="downloadBom"
      >下载示例BOM表</el-button
    >
  </div>
</template>
...
const downloadBom = () => {
  ...
  const data = [
    ...
    [
      ...
      "表贴电阻",
      "33R/1%/0603",
      "Uniohm厚声/YAGEO国巨/muRata村田/FH风华",
      "个",
      "4000",
    ],
    [
    ...
    [
      ...
      "直插压敏电阻",
      "20D391K",
      "Brightking台湾君耀/RUILON瑞隆源/SURGING绍鑫",
      "个",
      "200",
    ],
    ...
    [
      ...
      "表贴电容",
      "1nF/16V/5%(NPO)/0805",
      "Samsung三星/YAGEO国巨/muRata村田/FH风华/AVX",
      "个",
      "4000",
    ],
    [
      ...
      "表贴钽电容",
      "47uF/10V/A3216",
      "VISHAY威世/Kyocera Avx/ PANASONIC松下/KEMET(基美)",
      "个",
      "1000",
    ],
